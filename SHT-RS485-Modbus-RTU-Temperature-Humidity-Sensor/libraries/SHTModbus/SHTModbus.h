 ...
 *  @file SHTModbus.h
 *
 *  This library is for the "SHT RS485 Modbus RTU" series of sensors.
 ...
 *
 *  Wiring diagram of SHT with "Communication Converter Circuit":
...
#ifndef __SHT_MODBUS_H__
#define __SHT_MODBUS_H__
